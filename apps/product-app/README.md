...
Current status: scaffolded. The intended backend-ready flow lives in [../../specs/02-apps/product-app/spec.md](../../specs/02-apps/product-app/spec.md), and current delivery maturity lives in [../../specs/00-governance/implementation-tracker.md](../../specs/00-governance/implementation-tracker.md).
