...
const READY_PATH =
  "/r/kc-role/kc_role_fixture_1?tenantScope=organization&tenantScopeId=org_demo";
const TENANT_MISSING_PATH = "/r/kc-role/kc_role_fixture_1";
...
describe("/r/kc-role/$id Keycloak role detail route", () => {
