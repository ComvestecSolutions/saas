...
/**
 * `/r/branding` — canonical branding operations surface.
 *
...
export const Route = createAdminAppFileRoute("/r/branding")({
          ...
          <div style={{ display: "grid", gap: 8 }}>
            ...
            {tenantTargets.length === 0 ? (
              ...
              >
                ...
                pivot from{" "}
                <Link to="/r/tenants" data-testid="branding-list-pivot-tenants">
                  tenant directory
                </Link>{" "}
