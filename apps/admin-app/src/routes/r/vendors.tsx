...
/**
 * `/r/vendors` — spec-canonical Vendor Health v2 list surface
 ...
 * to `/r/vendor/$service` for each adapter row. Partial-failure
...
export const Route = createAdminAppFileRoute("/r/vendors")({
  loader: () =>
