...
/**
 * `/r/config/$moduleId/$configKey` — detail variant of the
...
export const Route = createAdminAppFileRoute("/r/config/$moduleId/$configKey")({
  loader: ({ params }) =>
...
function RuntimeConfigDetailRoute() {
  ...
  const closeDrawer = () => {
    ...
    void router.navigate({
      to: buildAdminRuntimeConfigPath() as "/r/config",
    });
  };
