...
/**
 * `/r/delivery/$deliveryId` — spec-canonical Webhook Delivery
 ...
 * convention shipped on `/r/incident/$incidentId` and
 * `/r/legal-hold/$holdId`:
...
export const Route = createAdminAppFileRoute("/r/delivery/$deliveryId")({
