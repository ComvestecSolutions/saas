...
/**
 * `/r/billing` — spec-canonical Billing Operations v2 surface
...
const RawSearchSchema = Schema.Struct({
  tenants: Schema.optional(Schema.String),
...
export const Route = createAdminAppFileRoute("/r/billing")({
      ...
      >
        ...
        {tenantTargets.length === 0 ? (
          ...
          >
            ...
            from{" "}
            <Link to="/r/tenants" data-testid="billing-list-pivot-tenants">
              tenant directory
            </Link>{" "}
