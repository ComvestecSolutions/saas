...
/**
 * `/r/webhook` — canonical webhook operations surface.
 *
...
export const Route = createAdminAppFileRoute("/r/webhook")({
...
function WebhookReadyRoute({ data }: { readonly data: ReadyData }) {
  const navigate = useNavigate({ from: "/r/webhook" });
