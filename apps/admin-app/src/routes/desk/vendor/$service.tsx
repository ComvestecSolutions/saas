...
/**
 * `/desk/vendor/$service` — spec-canonical Vendor Detail v2
 ...
 * `/desk/vendors`. The URL `$service` parameter is decoded
  ...
  return (
    ...
    >
      <ScreenHeader
        ...
        breadcrumbs={[
          { label: "Resources" },
          { label: "Vendors", href: "/desk/vendors" },
