...
/**
 * Loader for the spec-canonical `/r/notify/$id` Notification
 ...
 * loader-trio shape used by `/r/run/$id`,
 * `/r/incident/$incidentId`, `/r/legal-hold/$holdId`,
 * `/r/delivery/$deliveryId`, and `/r/api-key/$keyId`.
 */
