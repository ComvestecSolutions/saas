...
Current status: validated. The intended public-web responsibilities live in [../../specs/02-apps/public-web/spec.md](../../specs/02-apps/public-web/spec.md), and current delivery maturity lives in [../../specs/00-governance/implementation-tracker.md](../../specs/00-governance/implementation-tracker.md).
