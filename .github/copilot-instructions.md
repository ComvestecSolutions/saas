...
5. When touching `packages/platform/src/services/`, move concern-owned files into `access/`, `apps/`, `communication/`, `domains/`, or `governance/` instead of adding more root-level service siblings.
