...
export const reasonCatalogIds = [
  ...
  reasonCatalogId.keycloakRoleRead,
...
export const reasonCatalogRegistry: ReadonlyArray<ReasonCatalogEntry> = [
  ...
  {
    id: reasonCatalogId.keycloakRoleRead,
    displayLabel: "Keycloak role — read",
    moduleId: platformModuleId.keycloakRoleRead,
    minimumActorClass: actorType.supportOperator,
    requiresAttachment: false,
    auditActionsGated: [keycloakRoleReadAuditAction.readPerformed],
  },
  {
