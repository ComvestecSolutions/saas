...
const AdminRoutePathConstantSchema = Schema.Struct({
  ...
  accessControl: Schema.Literal("/r/access"),
  auditLog: Schema.Literal("/r/audit"),
  supportOperations: Schema.Literal("/r/support"),
  branding: Schema.Literal("/r/branding"),
  billing: Schema.Literal("/r/billing"),
  complianceRetention: Schema.Literal("/r/retention"),
  webhooksApiAccess: Schema.Literal("/r/webhook"),
});
...
export const adminRoutePath = Schema.validateSync(AdminRoutePathConstantSchema)(
  {
    ...
    featureFlags: "/r/flag",
    accessControl: "/r/access",
    auditLog: "/r/audit",
    supportOperations: "/r/support",
    branding: "/r/branding",
    billing: "/r/billing",
    complianceRetention: "/r/retention",
    webhooksApiAccess: "/r/webhook",
